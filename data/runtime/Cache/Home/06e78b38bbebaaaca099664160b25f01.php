...
<html lang="en">
	...
	<body class='live'>
		<div class='live-video'>
			<video src="" poster='./public//image/list@2x.png'></video>
			<div class='num'>
				<i></i>
				6582
			</div>
				...
				<li class="live-body">
					...
					<div class="body">
						...
						<div class="score">
							...
							<img src="./public/image/quantao@2x.png" style="left: calc(46vw - 25px)" alt="">
						</div>
						<!-- 这里是赏金 -->
						<div class="money">
							<p>12700<br><span>赏金</span></p>
							<img src="./public/image/vs@2x.png" alt="">
						</div>
						<div class="menu">
							<div class="image">
								<div class="red">
									<img src="./public/image/red@2x.png" alt="">
									<p>孙想想</p>
								</div>
								<div class="blue">
									<img src="./public/image/blue@2x.png" alt="">
									<p>杨永强</p>
								</div>
							</div>
							<div class="btn">
								<div class="red">
									<img src="./public/image/red-btn@2x.png" alt="">
									<p>掷胜</p>
								</div>
								<div class="blue">
									<img src="./public/image/blue-btn@2x.png" alt="">
									<p>掷胜</p>
								</div>
							</div>
						</div>
		...
		<div class="pay" style="bottom: -100%">
			...
			<img style="display: none" class="give" src="./public/image/zengsong@2x.png" alt="">
		</div>
		<!-- 提示弹框 -->
