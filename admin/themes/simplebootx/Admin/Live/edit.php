...
<div class="wrap js-check-wrap">
	...
	<form action="{:U('Live/live_save_post')}" method="post" class="form-horizontal js-ajax-forms" enctype="multipart/form-data">
			...
			<div class="span9">
				<table class="table table-bordered">
					<tr>
						<th width="80">直播名称</th>
						<td>
							<input type="text" style="width:400px;" name="live_title" id="title"  placeholder="名称不能为空" required value="{$data.live_title}"/>
					...
					<tr>
						<td>
							<div style="text-align: center;">
								<input type="hidden" name="smeta[thumb]" id="thumb" value="{$data.live_header_img}">
								<a href="javascript:upload_one_image('图片上传','#thumb');">
									<?php if(!empty($data['live_header_img'])) {?>
										<img src="<?php echo sp_get_asset_upload_path($data['live_header_img'])?>" id="thumb-preview" width="135" style="cursor: hand" />
									<?php }else {?>
